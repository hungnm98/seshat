...
- `TASK-001` Bootstrap runtime commands
- `TASK-002` Admin auth and dashboard
- `TASK-003` CLI ingestion and project token auth
- `TASK-004` Parser foundation for Go and Ruby
- `TASK-005` Git-native roadmap and task validation
